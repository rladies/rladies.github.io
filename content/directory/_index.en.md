...
[Fill out the form](/form/directory-update) to add a new entry or update an existing one.
To update an existing profile, choose the "Update directory entry" option in the form.
