...
![Ejemplo de tweet para un capítulo existente de R-Ladies](Chapter_SantaRosa.png)
...
![Ejemplo de tweet para un nuevo capítulo en formación](Chapter_Concepción.png)
