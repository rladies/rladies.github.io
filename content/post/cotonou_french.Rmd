---
title: "Le programme de mentoring de R-Ladies : le voyage de R-Ladies Cotonou"
author: "[Nadejda Sero](https://twitter.com/sbnadejda), organisatrice à [R-Ladies Cotonou](https://twitter.com/RLadiesCtn)"
date: "2020-08-04"
description: "Le programme de mentoring de R-Ladies"
tags: 
- communauté
- mentoring 
- afrique
...
Si vous souhaitez en savoir plus sur la manière de contribuer au blog de R-Ladies en général ou
souhaitez faire de recommendations, veuillez nous contacter par e-mail à christin@rladies.org.*

## Comment tout a commencé… ? 🤔

R-Ladies Cotonou est un groupe local de [R-Ladies Global](https://twitter.com/RLadiesGlobal) basé à Cotonou, au Bénin (Afrique de l'Ouest). À ce jour, nous avons 30 membres avec quatre femmes dans l'équipe organisatrice.  

L'idée de créer R-Ladies Cotonou est née sur Twitter ! Voici l'histoire ! 
...
<!-- ![*Rencontre avec R-Ladies pour la première fois! J'ai découvert R-Ladies, sur Twitter, par les réponses de [Mine Dogucu](https://twitter.com/MineDogucu?s=20) and [Laura Acion](https://twitter.com/_lacion_?s=20) à mon tweet.  Elles pourraient être considérées comme les marraines de R-Ladies Cotonou qui est né après ces échanges. J'étais juste partie tweeter sur mon enthousiasme pour les #rstats mais j'ai trouvé une communauté!*](../../image/rladies_cotonou_fig01.png){width=700px} -->
...
## Le Programme de mentoring de R-Ladies à la rescousse! 💪
...
Aujourd'hui, R-Ladies Cotonou est en bonne santé, surtout grâce au programme de mentoring ! Je le recommande à tout groupe local de R-Ladies qui a besoin d'aide pour mettre en place et organiser des rencontres, recruter des membres ou tout autre élément nécessaire à la vie du groupe.  
