---
title: "El programa de mentoría de R-Ladies: la historia de  R-Ladies Cotonou"
author: "[Nadejda Sero](https://twitter.com/sbnadejda), organizador en [R-Ladies Cotonou](https://twitter.com/RLadiesCtn)"
date: "2020-08-04"
description: "Programa de mentoría de R-Ladies"
tags: 
- community
- mentoring
- español
...
# El programa de mentoría de R-Ladies: la historia de R-Ladies Cotonou
...
<!-![*Encuentro con R-Ladies por primera vez! Descubrí R-Ladies en Twitter, a través de las respuestas de [Mine Dogucu](https://twitter.com/MineDogucu?s=20) y [Laura Acion](https://twitter.com/_lacion_?s=20) a mi tweet. Podrían ser consideradas como las madrinas de R-Ladies Cotonou, que nació luego de estos intercambios. Estaba twitteando sobre mi entusiasmo por #rstats, ¡pero encontré una comunidad!*](../../image/rladies_cotonou_fig01.png){width = 700px}->
...
# ¡El programa de mentoría de R-Ladies al rescate! 💪
...
El programa de mentoría de R-Ladies me dió voz para poder expresar mis dificultades como organizadora. Mi mentora compartió conmigo su experiencia en la organización de su propio capítulo. Me sentí mejor sabiendo que no estaba sola si me sentía perdida o por momentos sobrepasada. Lentamente, comencé a llevar mis propias sugerencias y ella me ayudó a hacerlas más concretas.
...
El programa de mentoría de R-Ladies ha sido beneficioso para mi capítulo. Con la ayuda de mi mentora pude encontrar formas de solucionar el problema de internet a largo plazo. Usamos emails y WhatsApp para compartir materiales para los eventos y ponernos en contacto entre los miembros. Estos métodos son baratos y la mayoría se siente cómoda con ellos. Sin embargo, aun aconsejamos el uso de Twitter y Meetup. 
...
¡Hoy R-Ladies Cotonou goza de buena salud gracias al programa de mentoría! Se lo recomiendo a cualquier capítulo que necesite ayuda para organizar reuniones, encontrar nuevos miembros o cualquier otra cosa necesaria para la vida del capítulo.
