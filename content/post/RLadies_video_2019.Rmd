...
Numbers for global R-Ladies chapters are shown in a way to highlight how we organize ourselves. We also show what was done and how much we grew in 2019. To be able to express that idea we chose _the number of chapters, the number of countries, the number of members, and the total number of events held in the year 2019_, because these are concrete indicators. The first three numbers were extracted from the [R-Ladies Community Board](https://benubah.github.io/r-community-explorer/rladies.html). The number of events was calculated using the [meetupr](https://github.com/rladies/meetupr) package, developed by R-Ladies.
...
_Third step_: with this plan in mind, it was time to edit the video. We did it using Doodly for the drawing-hand effects. Both music and fonts are provided by the software. The most laborious part was the synchronization of the audio with the drawing of the numbers and letters.
