---
title: "R-Ladies Online Meetups"
author: "R-Ladies Global Leadership Team"
date: "2020-04-24"
description: "R-Ladies Online Meetups"
tags: 
- community
- online-meetups
categories:
...
all_events %>% 
  ...
  count(simulateneous_events) %>% 
  arrange(desc(simulateneous_events))
```
